                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group row">
                                        ...
                                        <input required name="tgl_tagihan" value="<?= $pelanggan['tgl_tagihan']; ?>" type="number" value="<?= old('tgl_tagihan') ?>" class="form-control" id="tgl_tagihan" placeholder="Cukup Tuliskan Tanggal Saja">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group row">
                                        ...
                                        <textarea name="alamat_pemasangan" class="form-control" id="alamat_pemasangan" placeholder="Alamat Pemasangan"><?= $pelanggan['alamat_pemasangan']; ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
