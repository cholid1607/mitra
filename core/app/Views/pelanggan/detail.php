                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group row">
                                ...
                                <textarea disabled style="background-color: #ffffff;" name="alamat_pemasangan" class="form-control" id="alamat_pemasangan" placeholder="-"><?= $detail['alamat_pemasangan']; ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
