            ...
            $("#daftar-mitra").DataTable({
                ...
                "columns": [{
                    ...
                    render: function(data, type, row) {
                        ...
                        html += "<a href ='#' data-target='#resetModal" + data + "' data-toggle='modal' class='btn btn-danger btn-block btn-circle btn-sm mt-2' title = 'Reset Data Mitra' ><i class='fas fa-sync-alt'></i> Reset Data Mitra</a>";
                        html += "<div class='modal fade' id='resetModal" + data + "' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'>";
                        html += "<form action='<?= base_url(); ?>mitra/reset' method='post'>";
                        html += "<input type='hidden' name='id_mitra' value='" + data + "'>";
                        html += "<div class='modal-dialog' role='document'>";
                        html += "<div class='modal-content'>";
                        html += "<div class='modal-header'>";
                        html += "<h5 class='modal-title' id='exampleModalLabel'>Reset Data Mitra</h5>";
                        html += "<button class='close' type='button' data-dismiss='modal' aria-label='Close'>";
                        html += "<span aria-hidden='true'>×</span>";
                        html += "</button>";
                        html += "</div>";
                        html += "<div class='text-left modal-body'>Pilih 'Ya' untuk mereset data Mitra</div>";
                        html += "<div class='modal-footer'>";
                        html += "<button class='btn btn-secondary' type='button' data-dismiss='modal'>Tidak</button>";
                        html += "<button type='submit' class='btn btn-primary'>Ya</button>";
                        html += "</div>";
