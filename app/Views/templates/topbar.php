<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li>
            ...
            <!--
            <a href="#" class="nav-link text-red blink text-bold text-italic"><i class="fas fa-info-circle"></i>&nbsp;Fitur Input Error akan dinonaktifkan sementara pukul 15.30 s.d 16.00 untuk updating data</a>
            -->
        </li>
    </ul>
