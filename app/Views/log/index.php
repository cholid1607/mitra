...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-body">
                <form action="<?= base_url(); ?>log/index" method="post">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped dataTable dtr-inline collapsed" id="daftar-log" width="100%" cellspacing="0">
                        <thead>
                            <tr>
